...
export default function DiscoverCanadaHandbookPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8 pb-8">
      ...
      <Alert className="border-brand-navy/15 bg-white">
        <Info className="size-4 text-brand-navy" aria-hidden />
        <AlertTitle>Disclaimer</AlertTitle>
        <AlertDescription className="space-y-2 text-gray-500">
          <p>
          ...
          <p>
            ...
            <a href={IRCC_STUDY_GUIDE_HTML} target="_blank" rel="noopener noreferrer" className="font-medium text-gray-700 underline underline-offset-2">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-1 text-lg font-semibold text-gray-900">Attribution — Discover Canada</h2>
        <div className="mb-5 space-y-2 text-sm leading-relaxed text-gray-500">
          <p>
      ...
      <section aria-label="Discover Canada PDF viewer" className="space-y-3">
        <h2 className="text-lg font-semibold text-gray-900">Handbook (English PDF)</h2>
